...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 lg:px-0">
      <div className="max-w-7xl mx-auto flex h-14 items-center font-major">
        <div className="md:mr-4 flex justify-between w-full">
          <a href="#" className="mr-6 flex items-center space-x-2">
            <a href="/" className="logo">
              <span>Enzo Surhati | Portfolio Page</span>
            </a>
          </a>
          <nav className="md:flex hidden items-center space-x-6 text-lg font-medium">
            <a
              href="#about"
              className="transition-colors hover:text-foreground/80 text-foreground/60 font-major">
              About
            </a>
