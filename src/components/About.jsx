      ...
      <div className='bg-gray-100 py-12'>
        <div className='max-w-7x1 max-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <p className='mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl'>Hi, I'm Enzo</p>
            <p className='mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto'>
              A beginner fullstack software developer with experience in Web Development. Coding is not my only passion however. I am also deeply into gaming and finances, although I have only recently started exploring the latter.
            </p>
          </div>
          <div className='mt-10'>
            <div className='grid grid-cols-1 gap-12 lg:grid-cols-2'>
              <div>
                ...
                <p className='mt-4 text-lg text-gray-600'>
                  I began studying software few years ago by learning Java, but in the process realized that I'm more of a designer who envisions projects differently. So I have decided to go with Web Development.
                </p>
